...
def signin():
    ...
    if username == "admin" and password == "1234":
        ...
        Label(screen,text="Hello Y`all. Welcome",bg="#fff",ont=('Miscrosoft Yahei UI light',23, "bold"))
            #   font=('calibri',50,'bold')).pack(expand=True)
        screen.mainloop()
    elif username != "admin" and password !="1234":
        messagebox.showerror("Invalid","Fuck off now!")
    elif username != "admin":
...
Label = Label(frame,text="Don`t have an account?",fg="black",bg="white",font=('Miscrosoft Yahei UI light',9))
